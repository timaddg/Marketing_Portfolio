    ...
    <div className="min-h-screen bg-background dark:bg-gray-900">
      ...
      <section id="about" className="py-24 px-6 sm:px-8 lg:px-12 bg-background dark:bg-gray-800 font-sans">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-accent dark:text-blue-400 mb-10">
            About Me
          </h2>
          <div className="max-w-3xl">
            <p className="text-lg text-foreground dark:text-gray-300 mb-4 leading-relaxed">
      ...
      <section id="contact" className="py-24 px-6 sm:px-8 lg:px-12 bg-background dark:bg-gray-800 font-sans">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-accent dark:text-blue-400 mb-8">
            Get In Touch
          </h2>
          <div className="max-w-2xl">
            ...
            <a
              ...
              className="inline-flex px-6 py-3 rounded-full border-2 border-accent dark:border-blue-400 text-accent dark:text-blue-400 font-medium hover:bg-accent hover:text-white dark:hover:bg-blue-400 dark:hover:text-gray-900 transition-colors"
            >
              Send Email
            </a>
          </div>
