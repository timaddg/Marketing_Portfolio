...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-[#FDF0E6]/90 backdrop-blur-sm shadow-sm dark:bg-gray-900/90">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex-shrink-0">
            <button
              onClick={toggleTheme}
              className="text-xl font-bold text-gray-900 dark:text-white hover:opacity-80 transition-opacity cursor-pointer"
            >
